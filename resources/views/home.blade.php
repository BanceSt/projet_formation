    ...
    <div class="min-h-screen">
        ...
        <nav class="bg-gray-900 border-gray-200 ">
            <div class="max-w-full flex flex-wrap items-center justify-between p-4">
                ...
                <form class="max-w-4xl w-3/6 mx-auto ">
        ...
        <aside id="logo-sidebar" class="fixed mt-1.5 top-20 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full  border-r  sm:translate-x-0 bg-gray-800 border-gray-700" aria-label="Sidebar">
            <div class="h-full px-3 pb-4 overflow-y-auto bg-gray-800">
               <ul class="space-y-2 font-medium">
                  ...
                  <li>
                     <a href="#" class="flex items-center p-2  rounded-lg text-white  hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5  transition duration-75 text-gray-400  dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
