    ...
    <div class="px-3 py-2 border-b dark:border-gray-600">
        <div class="flex flex-wrap items-center">
            <div class="flex flex-wrap items-center space-x-1 rtl:space-x-reverse">
                ...
                <div id="textSizeDropdown" class="z-10 hidden p-2 bg-white rounded shadow w-72 dark:bg-gray-700">
                    <ul class="space-y-1 text-sm font-medium" aria-labelledby="toggleTextSizeButton">
                        <li>
                            <button data-text-size="16px" type="button" class="flex items-center justify-between w-full px-3 py-2 text-base text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">16px (Default)
                            </button>
                        </li>
                        <li>
                            <button data-text-size="12px" type="button" class="flex items-center justify-between w-full px-3 py-2 text-xs text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">12px (Tiny)
                            </button>
                        </li>
                        <li>
                            <button data-text-size="14px" type="button" class="flex items-center justify-between w-full px-3 py-2 text-sm text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">14px (Small)
                            </button>
                        </li>
                        <li>
                            <button data-text-size="18px" type="button" class="flex items-center justify-between w-full px-3 py-2 text-lg text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">18px (Lead)
                            </button>
                        </li>
                        <li>
                            <button data-text-size="24px" type="button" class="flex items-center justify-between w-full px-3 py-2 text-2xl text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">24px (Large)
                            </button>
                        </li>
                        <li>
                            <button data-text-size="36px" type="button" class="flex items-center justify-between w-full px-3 py-2 text-4xl text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">36px (Huge)
                            </button>
                        </li>
                    </ul>
                </div>
                ...
                <div id="textColorDropdown" class="z-10 hidden w-48 p-2 bg-white rounded shadow dark:bg-gray-700">
                    <div class="grid grid-cols-6 gap-2 group mb-3 items-center p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                        <input type="color" id="color" value="#e66465" class="w-full h-8 col-span-3 p-px px-1 border border-gray-200 rounded-md bg-gray-50 dark:bg-gray-700 dark:border-gray-600 hover:bg-gray-50 group-hover:bg-gray-50 dark:group-hover:bg-gray-700" />
                        <label for="color" class="col-span-3 text-sm font-medium text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">Pick a color</label>
                    </div>
                ...
                <!-- Heading Dropdown -->
                <div id="typographyDropdown" class="z-10 hidden p-2 bg-white rounded shadow w-72 dark:bg-gray-700">
                    <ul class="space-y-1 text-sm font-medium" aria-labelledby="typographyDropdownButton">
                        <li>
                            <button id="toggleParagraphButton" type="button" class="flex items-center justify-between w-full px-3 py-2 text-base text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">Paragraph
                        ...
                        <li>
                            <button data-heading-level="1" type="button" class="flex items-center justify-between w-full px-3 py-2 text-base text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">Heading 1
                                <div class="space-x-1.5">
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Cmd</kbd>
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Alt</kbd>
                        ...
                        <li>
                            <button  data-heading-level="2" type="button" class="flex items-center justify-between w-full px-3 py-2 text-base text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">Heading 2
                                <div class="space-x-1.5">
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Cmd</kbd>
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Alt</kbd>
                        ...
                        <li>
                            <button  data-heading-level="3" type="button" class="flex items-center justify-between w-full px-3 py-2 text-base text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">Heading 3
                                <div class="space-x-1.5">
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Cmd</kbd>
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Alt</kbd>
                        ...
                        <li>
                            <button  data-heading-level="4" type="button" class="flex items-center justify-between w-full px-3 py-2 text-base text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">Heading 4
                                <div class="space-x-1.5">
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Cmd</kbd>
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Alt</kbd>
                        ...
                        <li>
                            <button data-heading-level="5" type="button" class="flex items-center justify-between w-full px-3 py-2 text-base text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">Heading 5
                                <div class="space-x-1.5">
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Cmd</kbd>
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Alt</kbd>
                        ...
                        <li>
                            <button  data-heading-level="6" type="button" class="flex items-center justify-between w-full px-3 py-2 text-base text-gray-900 rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">Heading 6
                                <div class="space-x-1.5">
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Cmd</kbd>
                                    <kbd class="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-500">Alt</kbd>
