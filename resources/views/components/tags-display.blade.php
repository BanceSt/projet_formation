...
<div class="flex flex-row flex-wrap mb-2">
    @foreach ($tags as $tag)
    <span id="badge-dismiss-default" class="inline-flex items-center px-2 py-1 mb-2 mr-2 text-sm font-medium text-blue-800 bg-blue-100 rounded cursor-pointer dark:bg-blue-900 dark:text-blue-300 ">
        {{$tag}}
        @if ($delete_opt)
